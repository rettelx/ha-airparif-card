...
customElements.define('action-handler-airparif', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-airparif')) {
    return body.querySelector('action-handler-airparif') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-airparif');
